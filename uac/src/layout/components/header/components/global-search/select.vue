...
<template>
  <div :class="[ns.b(), ns.is('show', initShowSearch)]">
    <Icon v-if="!initShowSearch" icon="core-search" @click.stop="handleStartSearch" />
