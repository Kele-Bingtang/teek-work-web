...
import { listDataTreeList, type DictData } from "@/common/api/dictData";
...
export const useFormColumns = (defaultValue: ComputedRef<string>, isCascade?: ComputedRef<number>) => {
  ...
  const dictTypeColumns: FeedbackFormColumn<DictType.DictTypeInfo>[] = [
    {
      prop: "dictCode",
      label: "字典编码",
      el: "el-input",
  ...
  const dictDataColumns: FeedbackFormColumn<DictData.DictDataInfo>[] = [
    {
      prop: "parentId",
      label: "上级字典",
      el: "el-tree-select",
