...
import type { TransferTableColumn } from "@teek/components";
...
<template>
  <div :class="ns.b()">
    ...
    <el-dialog v-model="dialogVisible" title="添加用户" width="700" :class="ns.e('dialog')">
      <TransferSelect
        v-model="selectedIds"
...
@include b(user-select) {
  display: flex;
  width: 100%;

  :deep(.#{$teek-namespace}__dialog) {
