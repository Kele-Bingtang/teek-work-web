...
public interface UserRoleLinkService extends IService<UserRoleLink> {
    ...
    boolean checkRoleExistUser(RoleLinkUsersDTO roleLinkUsersDTO);
     ...
     * @return 是否存在
     */
    boolean checkUserExistRoles(UserLinkRolesDTO userLinkRolesDTO);

    /**
     * 添加用户到角色
     *
     * @param userLinkRolesDTO 用户绑定角色信息
     * @return 是否成功
     */
    boolean addRolesToUser(UserLinkRolesDTO userLinkRolesDTO);

    /**
     * 添加用户到角色
     *
     * @param roleLinkUsersDTO 用户绑定角色信息
     * @return 是否成功
     */
    boolean addUsersToRole(RoleLinkUsersDTO roleLinkUsersDTO);
