...
public interface RoleDeptLinkService extends IService<RoleDeptLink> {
     ...
     * @return 角色列表
     */
    TablePage<RoleLinkVO> listRoleLinkByDeptId(String deptId, String appId, RoleLinkInfoDTO roleLinkInfoDTO, PageQuery pageQuery);
     ...
     * @return 是否修改成功
     */
    Boolean updateOne(RoleDeptLinkDTO roleDeptLinkDTO);
     ...
     * @return 是否成功
     */
    boolean removeDeptFromRole(List<Long> ids);
